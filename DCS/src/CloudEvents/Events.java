...
//Events designed on a node
public class Events {
	
	int total_available_space;
	int total_required_space;
	
	//Calculates the amount of space available on online nodes
	//Returns 1 if the nodes can store the file along with replication else returns -1
	...
	//Upload File Event
	//Calls the splitting algorithm on a Node
	...
	//Retrieve File Event
	//Further triggers the retrieveFile function on Node
