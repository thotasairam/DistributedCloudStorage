...
public class Splitter {
	...
	//reinitialize parameters for recalculating new splits
	...
	//Arranges the available space on online nodes in descending order, along with node id
	...
	//Stub function used by arrangeNodesonSpace for sorting space in descending order
	...
	//Return the available space on a node for the passed Node ID
	...
	//Return the available space on Node by position
	...
	//Return the Node Id at the particular position
	...
	//Calculates regular/equals splits for a file
	...
	//Calculates unequal splits for a file
	...
	//Calculates replicas of primary splits
	...
	//Update the available space on each node, once the splits are successfully calculated
